...
public class StompNotificationService {
    ...
    // Keep in sync with StompChatService WS_URL
    ...
    public void connect(long userId, NotificationListener listener) {
    ...
    private void openWebSocket() {
        ...
        webSocket = client.newWebSocket(request, new WebSocketListener() {
            ...
            public void onMessage(WebSocket ws, String text) {
                Log.v(TAG, "Frame: " + text.substring(0, Math.min(text.length(), 200)));
                handleFrame(ws, text);
            }
    ...
    private void handleFrame(WebSocket ws, String frame) {
        if (frame.startsWith("CONNECTED")) {
            ...
            Log.d(TAG, "STOMP handshake complete, subscribing to " + topic);
            ...
            if (bodyStart != -1) {
                ...
                try {
                    ...
                    Log.e(TAG, "Failed to parse notification body: " + body, e);
                }
            }
